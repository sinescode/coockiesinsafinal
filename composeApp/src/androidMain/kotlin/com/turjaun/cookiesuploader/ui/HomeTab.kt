...
fun HomeTab(viewModel: MainViewModel, modifier: Modifier = Modifier) {
    ...
    Box(
        ...
        Column(modifier = Modifier.fillMaxSize().padding(16.dp)) {
            ...
            OutlinedTextField(value = username, onValueChange = { username = it }, label = { Text("Username") }, modifier = Modifier.fillMaxWidth(), colors = homeTextFieldColors(), shape = RoundedCornerShape(8.dp))
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(value = password, onValueChange = { password = it }, label = { Text("Password") }, modifier = Modifier.fillMaxWidth(), colors = homeTextFieldColors(), shape = RoundedCornerShape(8.dp), visualTransformation = if (passwordVisible) VisualTransformation.None else PasswordVisualTransformation(), trailingIcon = { IconButton(onClick = { passwordVisible = !passwordVisible }) { Icon(if (passwordVisible) Icons.Default.VisibilityOff else Icons.Default.Visibility, null) } }, keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Password))
            ...
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(value = cookies, onValueChange = { cookies = it }, label = { Text("Cookies") }, modifier = Modifier.fillMaxWidth().height(80.dp), colors = homeTextFieldColors(), shape = RoundedCornerShape(8.dp), maxLines = 3)
            Spacer(modifier = Modifier.height(16.dp))
...
@Composable
private fun homeTextFieldColors() = OutlinedTextFieldDefaults.colors(
